...
public class PanelJuego extends JPanel implements Runnable{    
    ...
    public JugadorMultijugador jugador = new JugadorMultijugador("", this, manejoTeclas, null, -1); 
    ...
    public void iniciarjuegoThread(){
        ...
        JugadorMultijugador jugador = new JugadorMultijugador(JOptionPane.showInputDialog(this, "Nombre de usuario: "), this, manejoTeclas, null, -1); 
        jugadoresConectados.add(jugador);  ///////***********////////
        Paquete00Acceder accederPaquete = new Paquete00Acceder(jugador.getNombreUsuario());
        if(servidorSocket != null){
            servidorSocket.agregarConexion(jugador, accederPaquete);
        }
